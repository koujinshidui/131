    ...
    method:{
        ...
        tabTitAlign:function(ele){
            var e = $('<div class="zm-edit-components-tabs-align">'
                ...
                +'<div class="zm-edit-components-tabs-radios-left"><label></label><span><i class="fa fa-align-left"></i><i class="fa fa-align-left"></i><i class="fa fa-align-left"></i></span></div>'
            ...
            switch(type){
                case "left":
                    label.eq(0).addClass("pickOn");
                    break;
                case "right":
                    label.eq(1).addClass("pickOn");
                    break;
                case "center":
                    label.eq(2).addClass("pickOn");
                    break;
                default:
                    label.eq(0).addClass("pickOn");
                    break;
