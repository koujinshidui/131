...
zmEditor.component.video={
    setting:function(box){
        ...
        var items3_1_c1 = zmEditor.component.setItems.config(config3_1_c1);
       ...
       // var btnWidth=nowEdit.find(".zm-videoBlackcover .zm-video-btn2").length>0? nowEdit.find(".zm-video-btn2"):nowEdit.find(".zm-video-btn1")
        ...
        var items3_1_c2 = zmEditor.component.setItems.config(config3_1_c2);
        ...
        var items3_1_c3 = zmEditor.component.setItems.config(config3_1_c3);
       ...
       //图标式
        ...
        var config3_2_c1 = [
            ...
            {type:'slider',element: nowEdit,flag: {title: "按钮大小", style: "tab_noColor",isColor:false,param:'scale',size: [30,100],goal:".video-playBtn-style1"}},
        ...
        var items3_2_c1 = zmEditor.component.setItems.config(config3_2_c1);
        ...
        var items3_2_c2 = zmEditor.component.setItems.config(config3_2_c2);
        ...
        var items4_c1 = zmEditor.component.setItems.config(config4_c1);
        ...
        var items4_c2 = zmEditor.component.setItems.config(config4_c2);
        ...
        var config4_c3 =[
            ...
            {type:'slider',element: nowEdit,flag: {title: "内容字间距<br><span>（像素）</span>", style: "tab_noColor",isColor:false,param:'fontSpace',size: [0,10],goal:".zm-video-introduc"}},
            {type: 'slider', element: nowEdit, flag: {title: '内容行距<br/>(像素)', style: 'tab_noColor', isColor: false, param: 'wordsLineHeight', size: [0, 20], goal: '.zm-video-introduc'}},
        ...
        var items4_c3 = zmEditor.component.setItems.config(config4_c3);
        ...
        var items4_c4 = zmEditor.component.setItems.config(config4_c4);
    ...
    videoHLnumber:function(ele) {
        ...
        //     var b=zmChoiceRadio.getRightVideoLi(g)
        //     console.log(g)
        //     var c='';
        //     var a=$(".zm-video-listL").val();
        //     a++;
        //     if(a>=6){
        //         a=6;
        //     }
        //     $(".zm-video-listL").val(a);
        //     for(var i=0;i<a;i++){
        //         c+=b
        //     }
        //    ele.find(".zm-videoBox").html(c)
        // })
        // e.find(".zm-video-listLdele").click(function () {
        //     var g=ele.find(".zm-videoBox").attr("data-type");
        //     var b=zmChoiceRadio.getRightVideoLi(g)
    ...
    videoAddVideo:function (ele) {
        var e=$('<div style="margin-top: 10px;"><span>添加视频：</span><div class="video-setAddvideo">'
            ...
            +'<div class="video-setAddvideo-choice"><span>选择</span><span class="video-setAddvideo-setbtn">设置</span>'
    ...
    videoplayBtncontent:function (ele) {
        ...
        e.find('.video-playBtntext').on('keyup',function(){
            if(zmChoiceRadio.getByteLen($(".video-playBtntext").val())>10){
                ...
                ele.find(".zm-videobtn-text").html($(this).val()+"<svg></svg>")
            }
    ...
    videoplayBtnStyle:function (ele) {
        ...
        e.find(".viedo-palyBtn-picstyle label").click(function () {
           ...
           //var b='video-playBtn-style'+(a+1);
            ...
            switch (a){
                case 0:
                    btnStyle='<svg class="video-playBtn-styles1" style="width: 100%; height:100%;vertical-align: middle;fill: #00AA91;overflow: hidden;" viewBox="0 0 1024 1024"  xmlns="http://www.w3.org/2000/svg">' +
                    ...
                    break;
                case 1:
                    btnStyle='<svg class="video-playBtn-styles2" style="width: 100%; height: 100%;vertical-align: middle;fill: #00AA91;overflow: hidden;" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">' +
                        '<path d="M96 0 96 1024 928 512Z"></path></svg>';
                    break;
                case 2:
                    btnStyle='<svg class="video-playBtn-styles3" style="width:100%; height: 100%;vertical-align: middle;fill: #00AA91;overflow: hidden;" viewBox="0 0 1072 1024" xmlns="http://www.w3.org/2000/svg">' +
                    ...
                    break;
                case 3:
                    btnStyle='<svg class="video-playBtn-styles4" style="width: 100%; height: 100%;vertical-align: middle;fill: #00AA91;overflow: hidden;" viewBox="0 0 1194 1024" xmlns="http://www.w3.org/2000/svg">' +
                    ...
                    break;
                case 4:
                    btnStyle='<svg class="video-playBtn-styles5" style="width: 145%; height: 100%;vertical-align: middle;fill: #00AA91;overflow: hidden;" viewBox="0 0 1792 1024" xmlns="http://www.w3.org/2000/svg">' +
                    ...
                    break;
                case 5:
                    btnStyle='<svg class="video-playBtn-styles6" style="width: 100%; height: 100%;vertical-align: middle;fill: #00AA91;overflow: hidden;" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">' +
...
// $(document).on('mouseover','.zm-video-btnHover',function () {
//     var _this = $(this).closest(".zm-videoTextWrap").next().find("svg");
//     _this.attr('data-oldColor',_this.css('fill')).css('fill',_this.attr('data-type-hoverbackgroundcolor'))
// }).on('mouseout','.zm-video-btnHover',function () {
//     var _this = $(this).closest(".zm-videoTextWrap").next().find("svg");
//     _this.css('fill',_this.attr('data-oldColor'))
// });
// $(document).on('mouseover','.zm-video-btnHover',function () {
//     var _this = $(this).closest(".zm-videoTextWrap").next().find(".zm-video-btn2");
//     _this.attr('data-oldColor',_this.css('color')).css('color',_this.attr('data-type-hoverColor'))
// }).on('mouseout','.zm-video-btnHover',function () {
//     var _this = $(this).closest(".zm-videoTextWrap").next().find(".zm-video-btn2");
//     _this.css('color',_this.attr('data-oldColor'))
