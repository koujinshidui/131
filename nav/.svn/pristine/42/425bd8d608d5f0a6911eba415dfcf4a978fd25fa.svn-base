...
$.fn.zmchoiceRadio=function () {
    // e.stopPropagation();
    //上下滚动条zm-choiceFile-optionsList
    ...
    $(document).on("click",function(e){
        ...
        $(document).find(".zm-choiceFile-optionsList").css("display","none")
    });
    ...
    $(document).on("mouseover mouseout",".zm-choicePart-upFileBtn",function (event) {
        ...
        if(event.type=="mouseover"){
            _this.closest(".zm-choiceFile-btn2").css("backgroundColor","#00c3b0")
        }else{
            _this.closest(".zm-choiceFile-btn2").css("backgroundColor","#49b1a6")
        }
    })
...
var zmChoiceRadio={
    ...
    choiceRadiolist:function () {
        ...
        $.each(a,function (i,value) {
            if(a.eq(i).hasClass("fa-check")){
                ...
                a.eq(i).closest(".zm-choiceFile-check").find(".zm-choiceFile-listWrap").css("display","block")
            }else{
                a.eq(i).css("display","none")
                a.eq(i).closest(".zm-choiceFile-check").find(".zm-choiceFile-listWrap").css("display","none")
            }
        })
    },
    callBack:{
        ...
        zmEditor.dialog.loading("html/href/choiceRadio.html", function (e) {
            ...
            $.ajax({
                ...
                success: function(e){
                    ...
                    var ch=' <div class="zm-choiceFile-category"><span class="zm-choiceRadio-categoryTop">音频类目</span></div>'+c+' <div class="zm-choiceFile-trash zm-choiceFile-categoryStyle" data-fid="-1"><span style="color:#49b1a9;font-size: 16px;" class="fa fa-trash"></span>'
                ...
                success: function(e){
                    ...
                    for(var i=0;i<len1;i++){
                        ...
                        for(var k=0;k<len2;k++){
                            ...
                            secondHtml+='<div class="zm-choiceFile-categoryStyle zm-choiceFile-dragMove" data-type="picture2" data-fid="'+fId2+'" data-fParentId="'+fParentId2+'" data-fName="'+name2+'" ><input class="zm-choiceFile-classifyInput" type="text" value="'+name2+'" readonly="">'
                        ...
                        firstHtml+='<div class="choiceFile-box11 zm-choiceFile-dragMove"><div class="zm-choiceFile-categoryStyle" data-type="picture1" data-fid="'+fId1+'"  data-fName="'+name1+'">'
                            ...
                            +''+toggleHtml+''
                            +'<input class="zm-choiceFile-classifyInput" type="text" value="'+name1+'" readonly="">'
                            +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span><div class="zm-choiceFile-tipSet">'
                            +'<div class="zm-choiceFile-tipSet-con" style="display: none;"><i class="tipSet-con-dot"></i>'
                    ...
                    $(document).on("click",".choicePicture-addBigclassify",function () {
                        ...
                        if(b){
                            var h=$('<div class="choiceFile-box11 zm-choiceFile-dragMove"><div class="zm-choiceFile-categoryStyle" data-type="picture1">'
                                +'<span class="zm-choicePicture-categoryStyle"></span>'
                                +'<input class="zm-choiceFile-classifyInput" type="text" value="" readonly="">'
                                +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span><div class="zm-choiceFile-tipSet">'
                                +'<div class="zm-choiceFile-tipSet-con" style="display: none;"><i class="tipSet-con-dot"></i>'
                                +'<div class="tipSet-con-list tipSet-con-list-add2 newAdd-Or-delete"><i class="add"></i> 添加子类目</div>'
                                +'<div class="tipSet-con-list tipSet-con-list-rename"><i class="rename"></i>重命名</div>'
                    ...
                    $(".zm-choiceFile-wrap").on("click",".tipSet-con-list-add2",function () {
                        ...
                        var b=$('<div class="zm-choiceFile-categoryStyle zm-choiceFile-dragMove" data-type="picture2"><input class="zm-choiceFile-classifyInput" type="text" value="" readonly="">'
                            +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span><div class="zm-choiceFile-tipSet">'
                            +'<div class="zm-choiceFile-tipSet-con" style="display: none;"> <i class="tipSet-con-dot"></i>'
                            +'<div class="tipSet-con-list tipSet-con-list-rename"><i class="rename"></i>重命名</div>'
                            +'<div class="tipSet-con-list" onclick="zmChoiceRadio.deleteThreeClassifyTitle(this)"><i class="delete"></i>删除</div>'
                    ...
                    $(document).on("mousedown.zm-page-setting-limousedown",".zm-choiceFile-categoryStyle",function(e){
                        ...
                        $(document).on("mouseup.zm-page-setting-li",function (e) {
                            ...
                            if(Math.abs(moveY-downY)>3||Math.abs(moveY-downY)==3){
                                ...
                                box.css({"transform":""});
                                zmChoiceRadio.getChoiceFileDragClassify(box)
                            }
                        })
                    });
                    //******************************************************************************************************
        ...
        zmEditor.dialog.loading("html/href/choiceVideo.html", function (e) {
            ...
            $.ajax({
                ...
                success: function(e){
                    ...
                    $.each(b, function(k,value) {
                        var h;
                        var d='<div class="zm-choiceFile-categoryStyle" data-choiceClassify="fShopFirstCategory" data-type="picture1" data-fid="'+b[k].fId+'" data-fName="'+b[k].fName+'">'
                            ...
                            +'</div>'
                            +'</div>';
                        if(b[k].list.length>0){
                            var e='';
                            $.each(value.list,function(i,o){
                                e+='<div class="zm-choiceFile-categoryStyle" data-choiceClassify="fShopSecondCategory" data-type="picture2" data-fid="'+value.list[i].fId+'" data-fParentId="'+value.list[i].fParentId+'" data-fName="'+value.list[i].fName+'">'
                                    +' <input class="zm-choiceFile-classifyInput" type="text"value="'+value.list[i].fName+'" readonly>'
                                    +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span>'
                                    +' <div class="zm-choiceFile-tipSet">'
                                    +' <div class="zm-choiceFile-tipSet-con">'
                                    +' <i class="tipSet-con-dot"></i>'
                    ...
                    var ch='<div class="zm-choiceFile-category"><span class="zm-choiceVideo-categoryTop">视频类目</span></div>'+c+' <div class="zm-choiceFile-trash zm-choiceFile-categoryStyle" data-fid="-1"><span style="color:#49b1a9;font-size: 16px;" class="fa fa-trash"></span>'
                        +'<span style="font-weight: bold">回收站</span></div><div style="width: 200px;height: 120px"></div>'
                    $(".zm-choicePicture-middleLTop").html(ch);
                    //首次获取视频列表
                   zmChoiceRadio.getAjaxVideoList("",0)
                    $.fn.zmchoiceRadio();
                    //点击类目添加背景样式
                    $(".zm-choiceFile-categoryStyle").each(function () {
                        if($(this).attr("data-fid")=="0"){
                    ...
                    $(document).on("click",".zm-choiceFile-categoryStyle",function () {
                        ...
                        _this.addClass("zm-choiceFile-ClassifyBackgroundColor")
                        zmChoiceRadio.getAjaxVideoList(a,b)
                    })
                    ...
                    $(document).on("click",".choicePicture-addBigclassify",function () {
                        ...
                        if(b){
                            var h=$('<div class="choiceFilel1-box zm-choiceFile-categroyStyle-wrap">'
                                ...
                                +'<span class="zm-choiceFile-children-toggle" onclick="zmChoiceRadio.childrenToggle(this)">-</span><span class="zm-choicePicture-categoryStyle"></span>'
                                ...
                                +'<div class="zm-choiceFile-tipSet-con" style="display: none;"><i class="tipSet-con-dot"></i><div class="tipSet-con-list tipSet-con-list-add newAdd-Or-delete"><i class="add"></i> 添加子类目</div>'
                    ...
                    $(".zm-choiceFile-wrap").on("click",".tipSet-con-list-add",function () {
                        console.log(123)
                        var b=$('<div class="zm-choiceFile-categoryStyle" >'
                            +' <input class="zm-choiceFile-classifyInput" type="text" value="" readonly="readonly">'
                            +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span>'
                            +' <div class="zm-choiceFile-tipSet">'
                            +' <div class="zm-choiceFile-tipSet-con">'
                            +' <i class="tipSet-con-dot"></i>'
                            ...
                            +' </div>'
                            +' </div></div>');
                        $(this).closest(".choiceFilel1-box").find(".choiceFilel2-box").append(b);
                        var obj= b.find("input[type=text]");
                        obj.attr("readonly",false);
                        obj.focus();
                        zmChoiceRadio.choiceFilerename();
                    ...
                    $(document).on("blur",".zm-choiceRlist1",function () {
                        $(this).css("display","none");
                       var fId=$(this).closest(".zm-choiceV-lists").attr("data-finfoid")
                    ...
                    $(document).on("blur",".zm-choiceFile-classifyInput",function () {
                        ...
                        fName=_this.val();
                        if(_this.attr("readonly")){
                            zmChoiceRadio.choiceRadioAddClassify(fId,fName,fParentId,function(id){
                                $(document).find(".zm-choiceFile-categoryStyle").each(function () {
                                    var _this=$(this);
                                    if(typeof(_this.attr("data-fid"))=="undefined"){
                                        _this.attr("data-fid",id);
        ...
        zmEditor.dialog.loading("html/href/choiceNews.html", function (e) {
            ...
            $.ajax({
                ...
                success: function(e){
                    ...
                    // $.each(b, function(k,value) {
                    //     var h;
                    //     var d='<div class="zm-choiceFile-categoryStyle" data-choiceClassify="fristId" data-type="picture1" data-fid="'+b[k].fId+'" data-fName="'+b[k].fName+'">'
                    //         +'<span class="zm-choiceFile-children-toggle" onclick="zmChoiceRadio.childrenToggle(this)">+</span>'
                    //         +'<span class="zm-choiceNews-categoryStyle"></span>'
                    //         +'<input class="zm-choiceFile-classifyInput" type="text" value="'+b[k].fName+'" readonly>'
                    //         +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span>'
                    //         +'<div class="zm-choiceFile-tipSet">'
                    //         +'<div class="zm-choiceFile-tipSet-con">'
                    ...
                    //             e+='<div class="zm-choiceFile-categoryStyle" data-choiceClassify="sencondId" data-type="picture2" data-fid="'+value.childrenList[i].fId+'" data-fParentId="'+value.childrenList[i].fParentId+'" data-fName="'+value.childrenList[i].fName+'">'
                    //                 +' <input class="zm-choiceFile-classifyInput" type="text"value="'+value.childrenList[i].fName+'" readonly>'
                    //                 +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span>'
                    //                 +' <div class="zm-choiceFile-tipSet">'
                    //                 +' <div class="zm-choiceFile-tipSet-con">'
                    //                 +' <i class="tipSet-con-dot"></i>'
                    ...
                    //     c+=h;
                    // });
                    // var ch='<div class="zm-choiceFile-category"><span class="zm-choiceNews-categoryTop">新闻类目</span></div>'+c+' <div class="zm-choiceFile-trash zm-choiceFile-categoryStyle" data-fid="-1"><span style="color:#49b1a9;font-size: 16px;" class="fa fa-trash"></span>'
                    //     +'<span style="font-weight: bold">回收站</span></div><div style="width: 200px;height: 120px"></div>'
                    // $(".zm-choicePicture-middleLTop").html(ch);
                    // //首次获取图片列表
                    // zmChoiceRadio.getAjaxNewsList("697","","")
                    // $.fn.zmchoiceRadio();
                    // //点击类目添加背景样式
                    // $(".zm-choiceFile-categoryStyle").each(function () {
                    //     if($(this).attr("data-fid")=="0"||$(this).attr("data-fid")=="1"){
                    ...
                    //     var c;
                    //     if(a=="sencondId"){
                    //         c=_this.closest(".choiceFilel2-box").siblings(".zm-choiceFile-categoryStyle").attr("data-fid");
                    //     }
                    //     $.each($(document).find(".zm-choiceFile-categoryStyle"),function (i,value) {
                    //         $(value).removeClass("zm-choiceFile-ClassifyBackgroundColor")
                    //     })
                    //
                    //     _this.addClass("zm-choiceFile-ClassifyBackgroundColor")
                    //     zmChoiceRadio.getAjaxNewsList(a,b,c)
                    // })
                    // //点击新闻列表修改名称
                    // $(".zm-choiceRadio-spli").on("click",".zm-chNlist-pencil",function () {
                    //     $(this).closest(".zm-choiceNewsList ").find(".zm-choiceNlist1").css("display","block")
                    // })
                    // $(".zm-choiceRadio-spli").on("keyup",".zm-choiceNlist1",function () {
                    //     $(this).closest(".zm-choiceNewsList").find(".zm-choiceNews-ListTitle").html($(this).val())
                    // })
                    //
                    // //点击重命名新闻标题
                    ...
                    //     $(this).css("display","none");
                    //     var _id=$(this).closest(".zm-choiceNewsList ").attr("data-fid")
                    //     var fName=$(this).closest(".zm-choiceNewsList ").find(".zm-choiceNlist1").val();
                    //     console.log(_id,fName)
                    //     zmChoiceRadio.choiceNewsTochangeName(_id,fName)
                    // })
                    //
                    //
                    // //增加新闻大类
                    ...
                    //         var h=$('<div class="choiceFilel1-box zm-choiceFile-categroyStyle-wrap">'
                    //             +'<div class="zm-choiceFile-categoryStyle">'
                    //             +'<span class="zm-choiceFile-children-toggle" onclick="zmChoiceRadio.childrenToggle(this)">-</span><span class="zm-choiceNews-categoryStyle"></span>'
                    //             +'<input class="zm-choiceFile-classifyInput" type="text" value="" readonly="readonly"><div class="zm-choiceFile-tipSet"><span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span>'
                    //             +'<div class="zm-choiceFile-tipSet-con" style="display: none;"><i class="tipSet-con-dot"></i><div class="tipSet-con-list tipSet-con-list-add newAdd-Or-delete"><i class="add"></i> 添加子类目</div>'
                    //             +'<div class="tipSet-con-list tipSet-con-list-rename"><i class="rename"></i>重命名</div><div class="tipSet-con-list" onclick="zmChoiceRadio.deleteClassifyTitle(this)"><i class="delete"></i>删除</div>'
                    //             +'</div></div></div><div class="choiceFilel2-box" style="display: block;"></div></div>')
                ...
                success: function(e){
                    ...
                    $.each(a,function (i,value) {
                        ...
                        listHtml +="<li class='zm-choiceBloggerList zm-choiceFile-check' data-fBlogContent='"+a[i].fBlogContent+"' data-fId='"+a[i].fId+"' data-fBlogCode='"+a[i].fBlogCode+"' data-fBlogTitle='"+a[i].fBlogTitle+"' data-fCreateUserAccount='"+a[i].fCreateUserAccount+"' data-fReadCount='"+a[i].fReadCount+"' data-fForwardCount='"+a[i].fForwardCount+"' data-fLikeCount='"+a[i].fLikeCount+"'>"
                            ...
                            +'<div class="zm-choiceNews-ListTitle">'+a[i].fBlogTitle+'</div><span>评论（'+a[i].replyCount+'）</span><span>|</span><span>收藏</span><span>|</span>'
                            +'<span>转发（'+a[i].fForwardCount+'）</span><span>|</span><span>点赞（'+a[i].fLikeCount+'）</span><span class="zm-choiceNewsListTime">'+timeLeft+timeRight+'</span></div><div class="zm-choiceBloggerLrboom">'
            ...
            $.ajax({
                ...
                success: function(e){
                    ...
                    for(var i=0;i<len1;i++){
                        ...
                        for(var j=0;j<len2;j++){
                            ...
                            for(var k=0;k<len3;k++){
                                ...
                                thirdHtml+='<div class="zm-choiceFile-categoryStyle" data-type="goods1" data-flagNumber="3" data-fId="'+fId3+'" data-fParentId="'+fParentId3+'" data-fSort="'+fSort3+'"><input class="zm-choiceFile-classifyInput" type="text" value="'+name3+'" readonly="">'
                                    +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span><div class="zm-choiceFile-tipSet">'
                                    +'<div class="zm-choiceFile-tipSet-con" style="display: none;"> <i class="tipSet-con-dot"></i>'
                                    +'<div class="tipSet-con-list tipSet-con-list-rename"><i class="rename"></i>重命名</div>'
                                    +'<div class="tipSet-con-list" onclick="zmChoiceRadio.deleteThreeClassifyTitle(this)"><i class="delete"></i>删除</div>'
                            ...
                            secondHtml+='<div class="zm-choiceFile-categoryStyle" data-type="goods1" data-flagNumber="2" data-fId="'+fId2+'" data-fParentId="'+fParentId2+'" data-fSort="'+fSort2+'"><span class="zm-choicePicture-categoryStyle"></span>'
                                +''+toggleHtml+''
                                +'<input class="zm-choiceFile-classifyInput" type="text" value="'+name2+'" readonly="">'
                                +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span><div class="zm-choiceFile-tipSet">'
                                +'<div class="zm-choiceFile-tipSet-con" style="display: none;"> <i class="tipSet-con-dot"></i>'
                                +'<div class="tipSet-con-list tipSet-con-list-add2 newAdd-Or-delete"><i class="add"></i> 添加子类目</div>'
                                +'<div class="tipSet-con-list tipSet-con-list-rename"><i class="rename"></i>重命名</div>'
                    ...
                    var topHtml='<div class="choiceFile-box11"><div class="zm-choiceFile-categoryStyle" data-fId="0">'
                        +'<span class="zm-choicePicture-categoryStyle" ></span>'
                        +'<input class="zm-choiceFile-classifyInput" type="text" value="全部商品" readonly="">'
                        +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span>'
                        +'</div>'
                        +'</div>';
                    var allHtml=topHtml+firstHtml+trashHtml;
                    ...
                    $(".zm-choiceFile-wrap").on("click",".tipSet-con-list-add2",function () {
                        ...
                        var b=$('<div class="zm-choiceFile-categoryStyle"><input class="zm-choiceFile-classifyInput" type="text" value="" readonly="">'
                            +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span><div class="zm-choiceFile-tipSet">'
                            +'<div class="zm-choiceFile-tipSet-con" style="display: none;"> <i class="tipSet-con-dot"></i>'
                            +'<div class="tipSet-con-list tipSet-con-list-rename"><i class="rename"></i>重命名</div>'
                            +'<div class="tipSet-con-list" onclick="zmChoiceRadio.deleteThreeClassifyTitle(this)"><i class="delete"></i>删除</div>'
                ...
                success: function(e){
                    ...
                    for(var i=0;i<len1;i++){
                        ...
                        for(var k=0;k<len2;k++){
                            ...
                            secondHtml+='<div class="zm-choiceFile-categoryStyle zm-choiceFile-dragMove" data-type="service2" data-fId="'+fid2+'" data-fName="'+name2+'" data-fParentId="'+fParentId2+'" data-fSort="'+fSort2+'" ><input class="zm-choiceFile-classifyInput" type="text" value="'+name2+'" readonly="">'
                                +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span><div class="zm-choiceFile-tipSet">'
                                +'<div class="zm-choiceFile-tipSet-con" style="display: none;"> <i class="tipSet-con-dot"></i>'
                                +'<div class="tipSet-con-list tipSet-con-list-rename"><i class="rename"></i>重命名</div>'
                                +'<div class="tipSet-con-list" onclick="zmChoiceRadio.deleteThreeClassifyTitle(this)"><i class="delete"></i>删除</div>'
                    ...
                    var topHtml='<div class="zm-choiceFile-category"><span class="zm-choiceService-categoryTop">服务类目</span></div><div class="choiceFile-box11"><div class="zm-choiceFile-categoryStyle" data-fId="0">'
                        +'<span class="zm-choiceService-categoryStyle" ></span>'
                        +'<input class="zm-choiceFile-classifyInput" type="text" value="全部服务" readonly="">'
                        +'<span class="fa fa-exclamation zm-choiceFile-sameNameTitle"></span>'
                        +'</div>'
                        +'</div>';
                    var allHtml=topHtml+firstHtml+trashHtml;
                    ...
                    $(document).on("click",".zm-choiceFile-categoryStyle",function () {
                        ...
                        _this.addClass("zm-choiceFile-ClassifyBackgroundColor")
                        zmChoiceRadio.getAjaxServiceList(a,"",12,0)
                    })
                    ...
                    $(document).on("blur",".zm-choiceFile-classifyInput",function () {
                        var _this=$(this);
                        var fName,fParentId,fSort;
                        var fChoice=_this.closest(".zm-choiceFile-categoryStyle").parent();
                        console.log(fChoice)
                        if(fChoice.hasClass("choiceFile-box11")){
                            console.log(1213)
                            fParentId=null;
                            fSort=fChoice.prev(".choiceFile-box11").attr("data-fSort");
                            fSort++;
                            _this.closest(".choiceFile-box11").attr("data-fSort",fSort)
                        }else{
                            fParentId=_this.closest(".choiceFile-box11").children(".zm-choiceFile-categoryStyle").attr("data-fid");
                            fSort=_this.closest(".zm-choiceFile-categoryStyle").prev(".zm-choiceFile-categoryStyle").attr("data-fSort")||0;
                            console.log(fSort)
                            fSort++;
                            console.log(fSort)
                            _this.closest(".zm-choiceFile-categoryStyle").attr("data-fSort",fSort)
                        }
                        fName=_this.val();
                        console.log(_this)
                        if(_this.attr("readonly")){
                            console.log(12312425)
                            zmChoiceRadio.choiceServiceAddClassify(fName,fParentId,fSort,function(id){
                                $(document).find(".zm-choiceFile-categoryStyle").each(function () {
                                    var _this=$(this);
                                    if(typeof(_this.attr("data-fid"))=="undefined"){
                                        _this.attr("data-fid",id);
                    ...
                    switch (flag){
                        ...
                        case "video":
                            ...
                            $(".zm-choiceRadio-middleR").find(".zm-choiceRadio-cheak").each(function () {
                                var _this=$(this);
                                if(_this.hasClass('fa-check')){
                                    videoLIscheak.push(_this.closest(".zm-choiceR-lists").attr("data-imgid"))
                                }
                            })
                        ...
                        case "service":
                            ...
                            $(".zm-choiceGoodsSpli").find(".zm-ChoiceNews-cheak").each(function () {
                                var _this=$(this);
                                if(_this.hasClass('fa-check')){
                                    serviceCheak.push(_this.closest(".zm-choiceGoodsList").attr("data-fidstr"))
                                }
                            })
        ...
        switch (flag){
            case "radio":
                if(a==0){
                    ...
                    b='从“全部新闻库”或“未分配类目新闻”类中删除新闻将导致文件被转移到回收站';
                }else{
                    b='删除音频文件至回收站吗？'
                }
                break;
            ...
            case "video":
                if(a==0){
                    ...
                    b='从“全部视频库”或“未分配类目视频”类中删除视频将导致文件被转移到回收站，你也可以在回收站中还原该视频';
                }else if(fFileId==-1){
                    b='从回收站删除视频将导致该视频永久性删除，且无法恢复，你确认要删除吗？'
                }else{
                    b='从其它类目中删除视频，视频不会进入回收站，确定删除吗？'
                }
                break;
            case "news":
                if(a==0){
                ...
                $(".zm-choiceFile-deleteTitle-keep").on("click",function () {
                    switch (flag){
                        case "radio":
                            ...
                            zmChoiceRadio.toBatchMusicDelete (radioIscheak,fFileId)
                            break;
                        case "album":
                            var albumIscheak=[];
                        ...
                        case "service":
                            ...
                            $(".zm-choiceService-middleR").find(".zm-ChoiceNews-cheak").each(function (i,value) {
                                var _that=$(this);
                                if(_that.hasClass('fa-check')){
                                    serviceCheak.push(_that.closest(".zm-choiceFile-check").attr("data-fserviceid"))
                                }
                            })
    ...
    getAjaxPictureList:function (fId,keyWorld,playStart,playLength) {
        $.ajax({
            ...
            dataType: "json",
            data: {'fId' : fId,'keyWorld' :keyWorld,'pageIndex' :playStart,'pageSize': playLength},
            success: function(e){
                var a=e.data;
                var listHtml='';
                $.each(a,function (i,value) {
            ...
            success: function(e){
                ...
                $.each(a,function (i,value) {
                    ...
                    listHtml +="<li class='zm-choiceBloggerList zm-choiceFile-check' data-fBlogContent='"+a[i].fBlogContent+"' data-fId='"+a[i].fId+"' data-fBlogCode='"+a[i].fBlogCode+"' data-fBlogTitle='"+a[i].fBlogTitle+"' data-fCreateUserAccount='"+a[i].fCreateUserAccount+"' data-fReadCount='"+a[i].fReadCount+"' data-fForwardCount='"+a[i].fForwardCount+"' data-fLikeCount='"+a[i].fLikeCount+"'>"
                        +'<div class="zm-choiceBloggerListLeft"><span class="zm-ChoiceNews-cheak fa"></span><img class="zm-choiceNewsImg" src="'+fImg+'" alt="">'
                        +'</div><div class="zm-choiceBloggerListRight"><div class="zm-choiceBloggerLrtop"><input class="zm-choiceNlist1" value="" type="text" >'
                        +'<div class="zm-choiceNews-ListTitle">'+a[i].fBlogTitle+'</div><span>评论（'+a[i].fReadCount+'）</span><span>|</span><span>收藏</span><span>|</span>'
                        +'<span>转发（'+a[i].fForwardCount+'）</span><span>|</span><span>点赞（'+a[i].fLikeCount+'）</span><span class="zm-choiceNewsListTime">'+timeLeft+timeRight+'</span></div><div class="zm-choiceBloggerLrboom">'
                        +'<div class="zm-choiceBloggerList-contentText">'+$(value.fBlogContent).text()+'</div>'
                        +'<span class="fa fa-trash" onclick="zmChoiceRadio.deleteFileTitle(this)" delete-title="blogger1"></span>'
                        +'<span class="fa fa-pencil zm-chNlist-pencil"></span></div></div></li>'
    ...
    //获取选择视频模块的视频列表
    getAjaxVideoList:function (obr,obj) {
        var dataContent;
        var choiceclassify=obr;
        var choicefid=obj;
        if(choiceclassify=="fShopFirstCategory"){
            dataContent={"fShopFirstCategory" : choicefid}
        }else if(choiceclassify=="fShopSecondCategory"){
            dataContent={"fShopSecondCategory" : choicefid}
        }else{
            dataContent={"fId" : choicefid}
        }
        $.ajax({
            type: "post",
            ...
            success: function(e){
                ...
                var listHtml='';
                $.each(a,function (i,value) {
                    listHtml +='<li class="zm-choiceV-lists zm-choiceFile-check" data-fid="'+a[i].fId+'" data-finfoId="'+a[i].fInfoId+'" data-fdramaName="'+a[i].fDramaName+'" data-fvideoUrl="'+a[i].fVideoUrl+'" data-fvideoImage="'+a[i].fVideoImage+'" data-fdetailCount="'+a[i].fDetailCount+'" data-fshopId="'+a[i].fShopId+'" data-finfoName="'+a[i].fInfoName+'" data-fvideoTime="'+a[i].fVideoTime+'"><div class="zm-choiceV-lisTop">'
                        +'<img class="zm-choiceV-listsImg" src="'+a[i].fVideoImage+'" alt=""><span class="zm-choiceRadio-cheak zm-choiceV-check fa"></span>'
                        +'<div class="zm-choiceVideoTime" style="opacity: 1;">'+a[i].fVideoTime+'</div><div class="zm-choiceRlist3" style="width: 200px">'
                        ...
                        +'<span class="zm-choiceVlist2">'+a[i].fInfoName+a[i].fDramaName+'</span></div></li>'
                })
    ...
    getAjaxServiceList:function (categoryId,servicetName,pageSize,startNum) {
        $.ajax({
            ...
            dataType: "json",
            data: {'catrgoryId' :categoryId,'servicetName' : servicetName,'pageSize' :pageSize,'startNum' :startNum},
            success: function(e){
                var a=e.data;
                console.log(a.length)
                var listHtml='';
                $.each(a,function (i,value) {
                    listHtml +=' <li class="zm-choiceGoodsList zm-choiceFile-check" data-fServiceId="'+a[i].fServiceId+'" data-fIdStr="'+a[i].fIdStr+'" data-fMainUrl="'+a[i].fMainUrl+'" data-fState="'+a[i].fState+'" data-fServiceSku="'+a[i].fServiceSku+'" data-fName="'+a[i].fName+'" data-fTagId="'+a[i].fTagId+'">'
    ...
    //删除音频路由
    toBatchMusicDelete:function (musicIds,fFileId) {
        $.ajax({
            type:"post",
            url:zmEditor.url.getRadioDeleteList,
            dataType: "json",
            data: {'fIds':musicIds,'fAlbums':fFileId},
            success:function (e) {
    ...
    //删除视频路由
    toBatchVideoDelete:function (musicIds,fFileId) {
        $.ajax({
            type:"post",
    ...
    toBatchRestore:function (_ids) {
        $.ajax({
            ...
            success:function (e) {
                console.log(111111)
                zmChoiceRadio.getAjaxPictureList(-1)
            }
        })
    },
    //删除博客路由
    ...
    //视频增加或修改类目
    choiceRadioAddClassify:function (fId,fName,fParentId,cb) {
        $.ajax({
            type: "post",
    ...
    //增加服务类目
    choiceServiceAddClassify:function (fName,fParentId,fSort,cb) {
        console.log(4321)
        $.ajax({
            type: "post",
            url:zmEditor.url.getServiceAddCategory,
            dataType: "json",
            data : {'fName':fName,'fParentId':fParentId,'fSort':fSort},
            success: function (e) {
                console.log("新增或修改成功")
                var data=e.data;
                console.log(data)
    ...
    choiceToMOveRadio:function (radioIds,categoryIds) {
        ...
        $.ajax({
            ...
            url: zmEditor.url.getRadioReviserList,
            dataType: "json",
            data: {'fIds':radioIds,'fAlbums':categoryIds},
            success:function (e) {
            }
        })
    },
    ...
    //拖拽类目时向后台传数据
    getChoiceFileDragClassify:function (b) {
        var a=b;
        var alls;
        var pictureClassify=[];
        ...
        switch (g){
            case "1":
                b='<li class="zm-videoPack"><div class="zm-videop-thumb"><div class="zm-videop-thumb-wrap"><div class="zm-videop-time zm-videop-timeRb">02:28</div>'
                    +'<a class="zm-videoBlackcover" title="" ><span class="zm-videobtn-setplace1 zm-video-btn video-playBtn-style1">'
            ...
            case "3":
                b='<li class="zm-videoPack"><div class="zm-videop-thumb"><div class="zm-videop-thumb-wrap">'
                    ...
                    +'<a class="zm-videoTextWrap" data-type="1"><span class="zm-videobtn-setplace1 zm-video-btn video-playBtn-style1 zm-video-btnHover"></span><div class="zm-video-title zm-videoInfo-text">这是新闻的标题</div>'
            ...
            case "4":
                b='<li class="zm-videoPack"><div class="zm-videop-thumb"><div class="zm-videop-thumb-wrap">'
                    ...
                    +'<a class="zm-videoTextWrap" data-type="1"><span class="zm-videobtn-setplace1 zm-video-btn video-playBtn-style1 zm-video-btnHover"></span><ul class="zm-videoInfo-list2"><li class="zm-video-title zm-videoInfo-text">这是新闻的标题<li>'
            ...
            case "5":
                b='<li class="zm-videoPack"><div class="zm-videop-thumb" ><div class="zm-videop-thumb-wrap">'
                    ...
                    +'<span class="zm-videobtn-setplace1 zm-video-btn zm-videobtn-text">开始播放</span></a>'
            ...
            case "6":
                b='<li class="zm-videoPack"><div class="zm-videop-thumb"><div class="zm-videop-thumb-wrap">'
                    +'<div class="zm-videop-time zm-videop-timeRb">02:28</div>'
                    +'<a class="zm-videoBlackcover" title="" ><span class="zm-videobtn-setplace2 zm-video-btn video-playBtn-style1">'
                    +'<svg class="video-playBtn-style1" style="width: 100%; height: 100%;vertical-align: middle;fill: #00AA91;overflow: hidden;" viewBox="0 0 1024 1024"  xmlns="http://www.w3.org/2000/svg"><path   d="M512 922.496c-226.752 0-410.56-183.808-410.56-410.496 0-226.752 183.808-410.56 410.56-410.56 226.752 0 410.56 183.808 410.56 410.56C922.56 738.752 738.752 922.496 512 922.496zM686.592 503.936c-21.12-12.224-268.416-155.008-280.768-162.112C390.336 332.992 374.72 344.256 374.72 359.36c0 11.648 0 307.968 0 324.864 0 16.64 17.28 24.704 30.464 17.408 17.984-9.984 266.24-153.536 281.408-162.496C700.224 531.136 700.416 512 686.592 503.936z"></path><path d="M365 315 L715 520 L365 725  Z" fill="#ffffff" p-id="3114"></path></svg>'
                    +'</span></a>'
            ...
            case "7":
                b='<li class="zm-videoPack"><div class="zm-videop-thumb"><div class="zm-videop-thumb-wrap">'
                    ...
                    +'<a class="zm-videoTextWrap" data-type="1"><span class="zm-videobtn-setplace1 zm-video-btn video-playBtn-style1 zm-video-btnHover"></span><div class="zm-videoInfo-list3"><div class="zm-videoInfo-title zm-video-title zm-videoInfo-text">这是新闻的标题</div>'
            ...
            case "8":
                b='<li class="zm-videoPack"><div class="zm-videop-thumb"><div class="zm-videop-thumb-wrap">'
                    +'<div class="zm-videop-time zm-videop-timeRb">00:58</div>'
                    +'<a class="zm-videoTextWrap" data-type="1"><span class="zm-videobtn-setplace2 zm-video-btn video-playBtn-style1 zm-video-btnHover"></span><div class="zm-videoInfo-list4"><div class="zm-videoInfo-title zm-video-title zm-videoInfo-text">这是新闻的标题</div>'
                    +'<div class="zm-videoInfo-introduc zm-video-introduc zm-videoInfo-text">这是一个新闻的简介，欢迎阅读。</div>'
                    +'<div class="zm-videoInfo-comment zm-video-comment zm-videoInfo-text"><span>464次播放</span><span>0次评论</span></div></div></a>'
                    +'<a class="zm-videoBlackcover" title="" >'
