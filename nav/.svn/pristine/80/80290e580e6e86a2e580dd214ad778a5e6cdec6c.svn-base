zmEditor.component.audio={
    setting:function(box){
        ...
        var tabs01 = $('<div></div>');
        var tabs01_c1 = $('<div></div>');
        var tabs01_c2 = $('<div></div>');
        var tabs02 = $('<div></div>');
        var tabs03 = $('<div></div>');
        var tabs04 = $('<div></div>');
        var config01_1 = [
            {type: "styleSelect",element: nowEdit},
            {type: "slider",element: nowEdit.find(".zm-edit-components-audio-wrap"),flag: {title: "边框颜色",style: "tab_color",isColor: true,param: "borderColor"}},
            {type: "slider",element: nowEdit.find(".zm-edit-components-audio-wrap"),flag: {title: "(光标悬停)边框颜色",style: "tab_color",isColor: true,param: "hoverBorderColor"}},
            {type: "slider",element: nowEdit.find(".zm-edit-components-audio-wrap"),flag: {title: "边框宽度",style: "tab_noColor",isColor: false,param: "borderWidth",size: [0,10]}},
            ...
            {type: "slider",element: nowEdit.find(".zm-edit-components-audio-wrap"),flag: {title: "(光标悬停)填充颜色",style: "tab_color",isColor: true,param: "hoverBackgroundColor"}},
            {type: "slider",element: nowEdit.find("svg"),flag: {title: "箭头颜色",style: "tab_color",isColor: true,param: "fill"}},
            {type: "slider",element: nowEdit.find("svg"),flag: {title: "(光标悬停)箭头颜色",style: "tab_color",isColor: true,param: "hoverFill"}}
        ];
        var config01_2 = [
            {type: "boxShadow",element: nowEdit.find(".zm-edit-components-audio-wrap"),flag: {style: "tab"}}
        ];
        var config01_3 = [
            {type: "choiceAudio",element: nowEdit},
            {type: "showName",element: nowEdit.find(".zm-edit-components-audio-title")},
            {type: "importName",element: nowEdit.find(".zm-edit-components-audio-title")},
            {type: "audioFont",element: nowEdit.find(".zm-edit-components-audio-title"),flag: {style: "mini",param: "color"}},
            {type: "slider",element: nowEdit.find(".zm-edit-components-audio-title"),flag: {title: "(光标悬停)文字颜色",style: "noTab_color",isColor: true,param: "hoverColor"}},
            {type: "slider",element: nowEdit.find(".zm-edit-components-audio-title"),flag: {title: "标题字间距",style: "noTab_noColor",isColor: false,param: "letter-spacing",size: [0,20]}},
            {type: "playMode",element: nowEdit}
        ];
        var config02_1 = [
        ...
        var items01_c1,items01_c2,items01,items02,items03,items04,tabs1List,tabsList;
        if(nowEdit.is(".mini_player")){
            items01_c1 = zmEditor.component.setItems.config(config01_1);
            items01_c2 = zmEditor.component.setItems.config(config01_2);
            items02 = zmEditor.component.setItems.config(config01_3);
            items01_c1.forEach(function(e){
                tabs01_c1.append(e);
            });
            items01_c2.forEach(function(e){
                tabs01_c2.append(e);
            });
        ...
        if(nowEdit.is(".play_panel")){
            items01_c1 = zmEditor.component.setItems.config(config02_1);
            items01_c2 = zmEditor.component.setItems.config(config02_2);
            items02 = zmEditor.component.setItems.config(config02_3);
            items01_c1.forEach(function(e){
                tabs01_c1.append(e);
            });
            items01_c2.forEach(function(e){
        ...
        if(nowEdit.is(".panel_list")){
            items01_c1 = zmEditor.component.setItems.config(config03_1);
            items01_c2 = zmEditor.component.setItems.config(config03_2);
            items02 = zmEditor.component.setItems.config(config03_3);
            items01_c1.forEach(function(e){
                tabs01_c1.append(e);
            });
            items01_c2.forEach(function(e){
        ...
        if(nowEdit.is(".panel_list_mini")){
            items01_c1 = zmEditor.component.setItems.config(config05_1);
            items01_c2 = zmEditor.component.setItems.config(config05_2);
            items02 = zmEditor.component.setItems.config(config05_3);
            items01_c1.forEach(function(e){
                tabs01_c1.append(e);
            });
            items01_c2.forEach(function(e){
        ...
        if(nowEdit.is(".list_album")){
            items01= zmEditor.component.setItems.config(config04_1);
            items02= zmEditor.component.setItems.config(config04_2);
            items03= zmEditor.component.setItems.config(config04_3);
            items04= zmEditor.component.setItems.config(config04_4);
    ...
    method:{
        styleSelect:function(ele){
            var e = $('<div class="zm-components-audio-method-styleSelect">'
                ...
                +'<div class="style-content"><ul><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul></div>'
            ...
            li.on("click",function(){
                ...
                ele.removeClass("mini-style-01 mini-style-02 mini-style-03 mini-style-04 mini-style-05 mini-style-06 mini-style-07 mini-style-08 mini-style-09 mini-style-10 mini-style-11 mini-style-12 mini-style-13 mini-style-14 mini-style-15");
                switch(_index){
                    case 0:
                        ele.addClass("mini-style-01");
                        break;
                    case 1:
                        ele.addClass("mini-style-02");
                        break;
                    case 2:
                        ele.addClass("mini-style-03");
                        break;
                    case 3:
                        ele.addClass("mini-style-04");
                        break;
                    case 4:
                        ele.addClass("mini-style-05");
                        break;
                    case 5:
                        ele.addClass("mini-style-06");
                        break;
                    case 6:
                        ele.addClass("mini-style-07");
                        break;
                    case 7:
                        ele.addClass("mini-style-08");
                        break;
                    case 8:
                        ele.addClass("mini-style-09");
                        break;
                    case 9:
                        ele.addClass("mini-style-10");
                        break;
                    case 10:
                        ele.addClass("mini-style-11");
                        break;
                    case 11:
                        ele.addClass("mini-style-12");
                        break;
                    case 12:
                        ele.addClass("mini-style-13");
                        break;
                    case 13:
                        ele.addClass("mini-style-14");
                        break;
                    case 14:
                        ele.addClass("mini-style-15");
                        break;
                }
            });
            return e;
        ...
        choiceAudio:function(ele){
            var e = $('<div class="zm-components-audio-method-choiceAudio">'
                +'<div><span class="zm-edit-text-title">选择音频</span><span class="choose_audio">设置</span></div>'
                +'<ul></ul>'
                +'</div>');
            var ul = e.find("ul");
            var li = $('<li><i class="fa fa-unlink fa-flip-horizontal"></i><span>当前未设置音频!</span></li>');
            if(ele.attr("data-type-link")){
                aa(ul);
            }else{
                ul.append(li);
            }
            function aa(el){
                el.empty();
                var arr = getLocal(ele.attr("id"));
                arr.forEach(function(val){
                    var li = $('<li><i class="fa fa-link fa-flip-horizontal"></i><span></span></li>');
                    li.find("span").text(val.creator+" : "+val.fName);
                    el.append(li);
                })
            }

            var choose = e.find(".choose_audio");
            choose.on("click",function(){
                zmChoiceRadio.choiceRadio({multiple: "false",callBack: setMiniPlay});
            });
            function setMiniPlay(data){
                var songName = ele.find(".songName");
                var singer = ele.find(".composer");
                songName.text(data[0].fName);
                singer.text(data[0].creator);
        ...
        importName:function(ele){
            var e = $('<div class="zm-components-audio-method-importName">'
                +'<div class="audio-importName-singer"><span>创作人 </span><input maxlength="20" type="text" placeholder="未知创作人"></div>'
                +'<div class="audio-importName-title"><span>音频标题 </span><input maxlength="20" type="text" placeholder="未知音频"></div>'
                +'</div>');
        ...
        playMode:function(ele){
           var e = $('<div class="zm-components-audio-method-playMode">'
                ...
                +'<div><label class="choice"></label><span>播放一次</span></div>'
                +'<div><label></label><span>循环播放</span></div>'
                +'</div>');
           var label = e.find("label");
           // if(ele.attr("data-loop") == "true"){
           //     label.eq(0).removeClass("choice");
        ...
        selAlbum:function(ele){
            var e = $('<div class="zm-components-audio-method-selAlbum">'
                +'<span class="zm-edit-text-title">选择音频文件</span>'
                +'<div class="choose-music">'
                +'<div class="onlySong"><label class="choice"></label><span>音频</span></div>'
                +'<div class="onlyAlbum"><label></label><span>专辑</span></div>'
                +'<div class="choose">选择</div></div>'
                +'<div class="music-content"><i class="fa fa-link fa-flip-horizontal"></i><span>当前未设置任何链接 !</span></div>'
                +'</div>'
            );

            var label = e.find("label");
            var choose = e.find(".choose");
            var txt = e.find(".music-content span");
            if(ele.attr("data-music-type") != "album"){
                ele.attr("data-music-type","single");
            }
            label.on("click",function(){
                var _this = $(this);
                var _index = label.index(this);
            ...
            choose.on("click",function(){
                ...
                if(judge == "single"){
                    zmChoiceRadio.choiceRadio({multiple: "false",callBack: setPanel});
                }
                if(judge == "album"){
                    zmChoiceRadio.choiceAlbum({multiple: "false",callBack: setPanel});
                }
            });
        ...
        albumChoice:function(ele){
            var e = $('<div class="zm-components-albumChoice">'
                +'<div><span class="zm-edit-text-title">专辑选择</span><a class="zm-components-albumChoice-button">设置</a></div>'
            ...
            btn.on("click",function(){
                zmChoiceRadio.choiceAlbum({multiple: '',callBack: popup_album});
            });
            function popup_album(data){
                var ul = e.find("ul");
                ul.empty();
                for(var i in data){
                    var li = $('<li><i class="fa fa-link fa-flip-horizontal"></i><p></p></li>');
                    li.find("p").text(data[i].fName);
                    ul.append(li);
                }
                console.log(data);
            }
