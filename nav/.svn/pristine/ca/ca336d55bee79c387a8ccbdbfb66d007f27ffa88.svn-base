...
zmEditor.component.function = {
    setting: function () {
        ...
        switch (functionType) {
            case "text":
                e = zmEditor.component.function.publicMethod.textSetting(content);
                break;
            case "img":
                e = zmEditor.component.function.publicMethod.imgSetting(content);
                break;
            case "btn":
                e = zmEditor.component.function.publicMethod.btnSetting(content);
                break;
            case "shape":
                e = zmEditor.component.function.publicMethod.shapeSetting(content);
                break;
            case "file":
                e = zmEditor.component.function.publicMethod.fileSetting(content);
                break;
            case "share":
                e = zmEditor.component.function.publicMethod.shareSetting(content);
                break;
            case "enter":
                e = zmEditor.component.function.publicMethod.enterSetting(content);
                break;
            case "option":
                e = zmEditor.component.function.publicMethod.optionSetting(content);
                break;
            default:
                e = zmEditor.component.function.publicMethod.functionSetting(nowEdit, functionType);
                break;
        }
        return e
    },
    searchMethod: {
        searchBarGetReady: function (ele) {
            ...
            searchMain.css({'width': 'auto'});
            searchBar.find('input').attr('placeholder', '').end().append(tempSpan);
            searchContent.attr('data-btnScale', parseInt(searchBtn.width()) / parseInt(searchBtn.height()));
        ...
        setDefaultContent: function (ele, flag) {
            var placeholderWord = ele.attr('class') == 'zm-component-function-searchBtn' ? $.trim(ele.text()) : $.trim(ele.html());
            var e = $('<div class="zm-edit-function-search-defaultCont" style="line-height: 61px">'
                ...
                + '<input type="text" placeholder="' + placeholderWord + '" style="padding: 0 5px;margin-left: 10px;border-radius: 5px">'
                + '</div>');
        ...
        searchBtnStyle: function (ele) {
            ...
            choicePoint.on('click', function () {
                ...
                ele.html(_this.next().html())
                    .width(origHeight * scale);
        ...
        setSearchBarStyle: function (ele) {
            var nowEdit = zmEditor.component.nowEdit(),
                ...
                searchBtn = content.find('.zm-component-function-searchBtn div'),
                searchBar = content.find('.zm-component-function-searchBar'),
                totalWidth = parseInt(nowEdit.width()) - 2;
            nowCont[0].className = content[0].className;
            nowBtn[0].className = searchBtn[0].className;
            nowBtn.html(searchBtn.html());
            nowCont.attr('data-btnScale', parseInt(searchBtn.parent().width()) / parseInt(searchBtn.parent().height()));
            nowBar.width(totalWidth - parseInt(btn.width()) - parseInt(btn.css('marginLeft')) + 'px')
        },
        resizeSearchBar: function (ele, w, h) {
            var component = ele;
            var searchContent = component.find('.zm-component-function-searchBar');
            var tempCont = searchContent.find('.searchBarTempCont');
            ...
            var totalW = parseInt(component.width())
                - parseInt(searchContent.css('borderWidth'))*2
                -  parseInt(searchBtn.css('borderWidth'))*2
                -  parseInt(searchBtn.css('margin-left')) - 2 ;
            if (h && tempCont) {
                searchContent.width(totalW - h * btnScale);
                searchBtn.width((h * btnScale) + 'px');
            }
            if (w) {
                searchContent.css('width', w - parseInt(searchBtn.width())
                    - parseInt(searchContent.css('borderWidth'))*2
    ...
    shoppingMethod: {
        ...
        shoppingCartStyle: function (ele) {
            ...
            var e = $('<div class="zm-edit-function-shopping-slider" style="padding: 10px 7px;">'
                ...
                + '<div class="zm-edit-shopping-cutBtn fa fa-angle-double-left fa-3x"></div>'
                ...
                + '<li data-type="net" class="itsChecked"><svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">'
                + '<path d="' + cartPath.net + '" style="transform: scale(1.15) translate(-8%,-3%)"></path></svg></li></ul>'
                + '<div class="zm-edit-shopping-cutBtn fa fa-angle-double-right fa-3x" style="right: 0;"></div>'
                + '</div></div>');
            ...
            e.find('li').on('click', function () {
                ...
                ele.find('path').attr({'d': _thisPath.attr('d'), 'style': style});
            });
            return e
        },
        ...
        shoppingCartLayOut: function (ele) {
            ...
            var tempStr = function (style, type) {
                return '<li class="zm-component-function-shopping-main"><div class="zm-component-function-content">'
            ...
            chooseBtn.on('click', function () {
                ...
                zmEditor.component.function.shoppingMethod.setCartNumPos(ele);
                return false
            });
            return e
        },
        setShoppingCartStyle: function (ele) {
            var nowEdit = zmEditor.component.nowEdit(), _this = ele,
                ...
                nowCont = nowEdit.find('.zm-component-function-content'),
                nowBtn = nowEdit.find('.zm-component-function-shopping-cartBtn'), finalH = parseInt(nowBtn.width()),
    ...
    shareMethod:{
        ...
        shareGetReady:function (ele) {
            ...
            var box2 = ele.closest('.zm-component-box2');
            var icoList = zmEditor.component.function.shareMethod.shareIconsHtml();

            box2.find('.zm-component-main-temp .zm-component-edit button').eq(0).remove();
    ...
    enterMethod:{
        enterGetReady:function (ele) {
            var form = ele.find('.zm-component-enter-form'),
            ...
            if(form.hasClass('infoInside')){
                ...
                input.on('focus',function () {
                    ...
                    var _this = $(this);
                    if(_this.val()==""){
                        _this.prev().css('display','table-cell')
                    }
                });
            }
    ...
    publicMethod: {
        ...
        /***********some config start***********/
        functionSetting: function (ele, functionType) {
            var nowEdit = ele;
            var searchBar = nowEdit.find('.zm-component-function-searchBar') ?
                nowEdit.find('.zm-component-function-searchBar') : null;
            var searchDefaultCont = searchBar.find('.searchBarTempCont') ? searchBar.find('.searchBarTempCont') : null;
            var searchBtn = nowEdit.find('.zm-component-function-searchBtn') ?
                nowEdit.find('.zm-component-function-searchBtn') : null;
            var tabs1_c1 = $('<div></div>'), tabs1_c2 = $('<div></div>'),
                tabs2_c1 = $('<div></div>'), tabs2_c2 = $('<div></div>'),
                tabA3 = $('<div></div>');
            var config1_c1 = [
                {
                    type: 'slider',
                ...
                {type: 'radiu_ordinary', element: searchBar, flag: ''}
            ];
            var config1_c2 = [
            ...
            /**********************************searchBar end*********************************************/
            var tabB1 = $('<div></div>'), tabB2 = $('<div></div>');
            var configB1 = [
                {
            ...
            if (functionType == 'shopping') {
                var itemsB1 = zmEditor.component.setItems.config(configB1);
                itemsB1.forEach(function (e) {
                    tabB1.append(e);
                });
                var itemsB2 = zmEditor.component.setItems.config(configB2);
                itemsB2.forEach(function (e) {
                    tabB2.append(e);
                });
                tabsList = [{title: "排版", content: tabB1}, {title: "设置", content: tabB2}];
            }
        ...
        shapeSetting: function (ele) {
            ...
            var items = zmEditor.component.setItems.config(config3);
            items.forEach(function (e) {
                tabs.append(e)
            });
            var tabs2 = $('<div></div>');
            var items2 = zmEditor.component.setItems.config(config4);
            items2.forEach(function (e) {
                tabs2.append(e)
            });
        ...
        shareSetting:function (ele) {
            ...
            var item = zmEditor.component.setItems.config(config);
            item.forEach(function (e) {tab.append(e)});
            return zmEditor.component.setItems.tabs([{title:'设置',content:tab}]);
        },
        enterSetting:function (ele) {
            ...
            var config2 = [
                ...
                {type:'slider',element:inputBox.not('.textAreaBox'),flag:{
                    title: "文本框<br/>高度", style: "noTab_noColor", isColor: false, param: "height",size:[10,40]
                }},
            ...
            var items3 =  zmEditor.component.setItems.config(config3);
            items3.forEach(function (e) {tabs3.append(e)});
            var tabsList = [
                {title: "常规", content: tabs1},
        ...
        optionSetting:function (ele) {
            ...
            var item1 = zmEditor.component.setItems.config(config1);
            item1.forEach(function (e) {tab1.append(e)});
            var tab2 = $('<div></div>');
            var config2 = [
                {type:'enter_enterSubmitWord',element:submitBtn,flag:''},
                {
            ...
            var item2 = zmEditor.component.setItems.config(config2);
            item2.forEach(function (e) {tab2.append(e)});
